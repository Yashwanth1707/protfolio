...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: <FaGithub size={24} />, href: "https://github.com/Yashwanth1707", label: "GitHub" },
    { icon: <FaLinkedin size={24} />, href: "https://www.linkedin.com/in/yashwanth-g-4899b2132/", label: "LinkedIn" },
